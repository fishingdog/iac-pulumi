...
export PUBLIC_SUBNET_CIDER_LIST="10.1.15.0/24, 10.1.17.0/24"
export PUBLIC_SUBNET_TAG_NAME_LIST="public_subnet_aria, public_subnet_bria"

export PRIV_SUBNET_CIDER_LIST="10.1.205.0/24, 10.1.207.0/24"
export PRIV_SUBNET_TAG_NAME_LIST="private_subnet_aron, private_subnet_bron"
